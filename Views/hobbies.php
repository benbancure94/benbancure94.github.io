            ...
            <div class="ben-portfolio-cont">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <p>
                            I love to listen to music, mostly classical and oldies-but-goodies, yet I love also to listen to modern ones.
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div>
                        ...
                        <h5>Web Surfing</h5>
                        <p>
                            I browse my social media accounts, often Facebook, but to a limited extent.
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div>
                        ...
                        <h5>Playing Games</h5>
                        <p>
                            I love to play games that makes me use my brain such as word, math, and memory games.
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div>
                        ...
                        <p>
                            I love to watch videos especially that are related to my skills and interests.
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <p>
                            I love creating software application such as web and desktop application on my spare time.
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div>
                        ...
                        <h5>Praying</h5>
                        <p>
                            Praying to Almighty God is the means against all sorts of challenges and hardships.
                        </p>
                    </div>
                </div>
            </div>
