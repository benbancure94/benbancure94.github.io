...
<head>
    ...
    <title>My Portfolio - Characteristics</title>
            ...
            <div class="ben-portfolio-cont">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <h5>Patriot</h5>
                        <p>
                            No country will I ardently love more than my native land, the Philippine Islands. I love its culture, its people, language, and its legacy to its modern citizens. 
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        ...
                        <h5>Humble</h5>
                        <p>
                            I am not an arrogant person. I do not boast my skills and talents as if I were better than them.
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div>
